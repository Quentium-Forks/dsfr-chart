            ...
            <tbody>
              ...
              >
                ...
                >
                  ...
                  <div
                    v-else-if="(tableData[0].includes('Axes') && !tableData[0].includes('UBM')) && columnIndex === 2"
                  >
                  ...
                  <div
                    v-else-if="((tableData[0].includes('Auteur') && columnIndex === 0) || ((tableData[0].includes('Auteur') && tableData[0].includes('Verbatim')) || (tableData[0].includes('Support') && tableData[0].includes('Verbatim') && !tableData[0].includes('Axes'))) && columnIndex === 1)"
                  >
                  ...
                  <div
                    v-else-if="((tableData[0].includes('Site') && tableData[0].includes('Verbatim') && columnIndex === 3) || (tableData[0].includes('Portée') && columnIndex === 1))"
                  >
