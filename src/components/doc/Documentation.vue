...
const examples = ref([
  ...
  },
  {
    ...
    graphs: [{ component: BarLineChart, title: 'Évolution du nombre de naissances et du taux de natalité', desc: 'France hors Mayotte, naissances en milliers et taux de natalité pour mille femmes. Insee, 16/01/2024', props: FAKE_DATA.barLineChart.default }],
  },
  {
  ...
  },
  {
    ...
    graphs: [
      ...
      { component: MapChartReg, noPalette: true, heading: '3. Régions', props: FAKE_DATA.mapChart.singleRegion },
    ],
  },
]);
</script>
