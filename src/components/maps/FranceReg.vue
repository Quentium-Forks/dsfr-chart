...
<template>
  ...
  >
    ...
    >
      <path
        class="FR-20R"
        :style="{ display: props.displayDep['FR-20R'] }"
      ...
      <path
        class="FR-PAC"
        :style="{ display: props.displayDep['FR-PAC'] }"
      ...
      <path
        class="FR-OCC"
        :style="{ display: props.displayDep['FR-OCC'] }"
      ...
      <path
        class="FR-ARA"
        :style="{ display: props.displayDep['FR-ARA'] }"
      ...
      <path
        class="FR-NAQ"
        :style="{ display: props.displayDep['FR-NAQ'] }"
      ...
      <path
        class="FR-BRE"
        :style="{ display: props.displayDep['FR-BRE'] }"
      ...
      <path
        class="FR-PDL"
        :style="{ display: props.displayDep['FR-PDL'] }"
      ...
      <path
        class="FR-CVL"
        :style="{ display: props.displayDep['FR-CVL'] }"
      ...
      <path
        class="FR-NOR"
        :style="{ display: props.displayDep['FR-NOR'] }"
      ...
      <path
        class="FR-HDF"
        :style="{ display: props.displayDep['FR-HDF'] }"
      ...
      <path
        class="FR-IDF"
        :style="{ display: props.displayDep['FR-IDF'] }"
      ...
      <path
        class="FR-GES"
        :style="{ display: props.displayDep['FR-GES'] }"
      ...
      <path
        class="FR-BFC"
        :style="{ display: props.displayDep['FR-BFC'] }"
