...
<template>
  ...
  >
    ...
    >
      <path
        class="CORSE"
        :style="{ display: config.displayDep['CORSE'] }"
      ...
      <path
        class="NICE"
        :style="{ display: config.displayDep['NICE'] }"
      ...
      <path
        class="AIX-MARSEILLE"
        :style="{ display: config.displayDep['AIX-MARSEILLE'] }"
      ...
      <path
        class="MONTPELLIER"
        :style="{ display: config.displayDep['MONTPELLIER'] }"
      ...
      <path
        ...
        :style="{ display: config.displayDep['CLERMONT-FERRAND'] }"
      ...
      <path
        class="BORDEAUX"
        :style="{ display: config.displayDep['BORDEAUX'] }"
      ...
      <path
        class="TOULOUSE"
        :style="{ display: config.displayDep['TOULOUSE'] }"
      ...
      <path
        class="GRENOBLE"
        :style="{ display: config.displayDep['GRENOBLE'] }"
      ...
      <path
        class="LIMOGES"
        :style="{ display: config.displayDep['LIMOGES'] }"
      ...
      <path
        class="POITIERS"
        :style="{ display: config.displayDep['POITIERS'] }"
      ...
      <path
        class="RENNES"
        :style="{ display: config.displayDep['RENNES'] }"
      ...
      <path
        class="NANTES"
        :style="{ display: config.displayDep['NANTES'] }"
      ...
      <path
        class="ORLEANS-TOURS"
        :style="{ display: config.displayDep['ORLEANS-TOURS'] }"
      ...
      <path
        class="DIJON"
        :style="{ display: config.displayDep['DIJON'] }"
      ...
      <path
        class="NORMANDIE"
        :style="{ display: config.displayDep['NORMANDIE'] }"
      ...
      <path
        class="LILLE"
        :style="{ display: config.displayDep['LILLE'] }"
      ...
      <path
        class="AMIENS"
        :style="{ display: config.displayDep['AMIENS'] }"
      ...
      <path
        class="REIMS"
        :style="{ display: config.displayDep['REIMS'] }"
      ...
      <path
        class="STRASBOURG"
        :style="{ display: config.displayDep['STRASBOURG'] }"
      ...
      <path
        class="NANCY-METZ"
        :style="{ display: config.displayDep['NANCY-METZ'] }"
      ...
      <path
        class="VERSAILLES"
        :style="{ display: config.displayDep['VERSAILLES'] }"
      ...
      <path
        class="CRETEIL"
        :style="{ display: config.displayDep['CRETEIL'] }"
      ...
      <path
        class="PARIS"
        :style="{ display: config.displayDep['PARIS'] }"
      ...
      <path
        class="BESANCON"
        :style="{ display: config.displayDep['BESANCON'] }"
      ...
      <path
        class="LYON"
        :style="{ display: config.displayDep['LYON'] }"
